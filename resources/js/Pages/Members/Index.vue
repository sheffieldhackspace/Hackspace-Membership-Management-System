            ...
            <div class="mx-auto max-w-7xl space-y-6 sm:px-6 lg:px-8">
                <div class="bg-white p-4 shadow sm:rounded-lg sm:p-8">
                    <div class="mb-4 flex space-x-4">
                        ...
                        <button
                            class="bg-brand text-white rounded-md p-2 "
                            @click="filterMembers"
                        >
                            Search
                        </button>
                    ...
                    <div class="grid grid-cols-12 gap-y-3 divide-y divide-gray-300 items-stretch">
                        <div class="col-span-4 text-sm text-gray-900 pt-3 border-none">
                            <strong>Name</strong>
                        </div>
                        <div class="col-span-2 text-sm text-gray-900 pt-3 border-none">
                        ...
                        <div class="col-span-2 text-sm text-gray-900 pt-3 border-none content-end pr-4">
                        ...
                        <template
                            ...
                            :key="member.id"
                        >
                            <div class="col-span-4 text-sm text-gray-900 pt-3 flex items-center">
                                {{ member.name }}
                            </div>
                            <div class="col-span-2 text-sm text-gray-900 pt-3 flex items-center">
                                {{ member.knownAs }}
                            </div>
                            <div class="col-span-2 text-sm text-gray-900 pt-3 flex items-center">
